...
# Stacks:
## No kata-1 utilizei o C# , já que vocês usam ele no dia a dia e como queriam testar a lógica e domínio básico da linguagem decidi por usar ela mesmo .

## No kata-2 utilizei o React no front-end e o TypeScript no back-end , pois achei válido pra ficar o mesmo ecossistema nessa stack , além do mais tive minhas últimas experiências no back-end com node , o que ajudou e agilizou na escrita do código .
...
## kata-4
### Eu só utilizei o pandas e o numpy em projetos básicos da faculdade , nada muito profundo . precisei ver uns vídeos no youtube pra rever o básico novamente como esse aqui: https://www.youtube.com/watch?v=C0aj3FjN5e0, além da documentacao do pandas onde eles tem um get started muito intuitivo, e tive uma ajuda da IA nesse caso , pra regras mais complexas , claro sempre entendendo a lógica por trás ..